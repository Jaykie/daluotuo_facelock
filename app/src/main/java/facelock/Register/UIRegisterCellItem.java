 ...
 */
public class UIRegisterCellItem extends UIView implements View.OnClickListener{
    ImageButton btnClose;
    TextView textTitle;

    public void CreateUI(int layoutId, ViewGroup parent) {
        LoadLayoutRes(layoutId, parent);
        textTitle = (TextView) findViewById(R.id.register_item_title);//找到Textviewname
